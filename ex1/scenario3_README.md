...
(Low Severity)                        (High Severity)
     │                                      │
     ▼                                      ▼
[Assign to Support Tech]              [Assign to Senior Tech]
     │                                      │
     ▼                                      ▼
[Investigate (Support Tech)]          [Investigate (Senior Tech)]
     │                                      │
     └───────┬──────────────────────────────┘
             │
             ▼
<Can Problem Be Resolved Internally?>
             │
     ┌───────┴──────────────────────────────┐
 (Yes / Internal)                     (No / External)
     │                                      │
     ▼                                      ▼
[Fix Problem Internally]              [Escalate to External Provider]
     │                                      │
     └───────┬──────────────────────────────┘
             │
             ▼
